...
public class StateCensusAnalyserTest{
    ...
    StateCensusAnalyser stateCensusAnalyser = new StateCensusAnalyser();
       @Test
        public void givenIndianStateCensusDataWhenSortedOnPopulationDensityShouldReturnMostPopulatedDensityAtFirst() {
            try {
        ...
        @Test
        public void givenIndianStateCensusDataWhenSortedOnPopulationDensityShouldReturnLessPopulatedDensityAtLast() {
            try {
                stateCensusAnalyser.loadIndiaCensusData(INDIA_STATE_CENSUS_CSV_FILE_PATH);
                String sortedCensusData = stateCensusAnalyser.getStateWiseSortedSDensity();
                CensusDAO[] stateCensuses = new Gson().fromJson(sortedCensusData, CensusDAO[].class);
