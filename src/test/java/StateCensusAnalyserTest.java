import com.blabz.census_analyser.CSVStateCensus;
...
public class StateCensusAnalyserTest {
    ...
    @Test
    public void givenIndiaStateCensusDataWhenSortedOnStateShouldReturnsFirstPositionAndhraPardesh() {
        try {
            stateCensusAnalyser.loadIndiaCensusData(INDIA_STATE_CENSUS_CSV_FILE_PATH);
            String sortedCensusData = stateCensusAnalyser.getStateSortedCensusData();
...
@Test
public void givenIndiaStateCensusDataWhenSortedOnStateShouldReturnsLastPositionWestBengal() {
        try {
        stateCensusAnalyser.loadIndiaCensusData(INDIA_STATE_CENSUS_CSV_FILE_PATH);
        String sortedCensusData = stateCensusAnalyser.getStateSortedCensusData();
        CSVStateCensus[] censusCSV = new Gson().fromJson(sortedCensusData,CSVStateCensus[].class);
